...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Editar Oficios</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("oficios/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-agenda"  value="<?php  echo $data['agenda']; ?>" type="number" placeholder="Nº da Agenda" step="1"  name="agenda"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-data" class="form-control datepicker  datepicker"  value="<?php  echo $data['data']; ?>" type="datetime" name="data" placeholder="Clique para escolher" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-destino"  value="<?php  echo $data['destino']; ?>" type="text" placeholder="Comece a digitar para buscar" list="destino_list"  name="destino"  class="form-control " />
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-oficio"  value="<?php  echo $data['oficio']; ?>" type="text" placeholder="Nº do ofício"  name="oficio"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-pauta"  value="<?php  echo $data['pauta']; ?>" type="text" placeholder="Comece a digitar para buscar" list="pauta_list"  required="" name="pauta"  class="form-control " />
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <textarea placeholder="Observações adicionais que julgar pertinente. Lembre-se: O que você adicionar aqui irá te ajudar a encontrar depois pela pesquisa" id="ctrl-observacoes"  rows="5" name="observacoes" class="htmleditor form-control"><?php  echo $data['observacoes']; ?></textarea>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="form-group ">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="">
                                                                            <input id="ctrl-adicionado_por"  value="<?php  echo $data['adicionado_por']; ?>" type="text" placeholder="Entrar  Adicionado Por"  readonly required="" name="adicionado_por"  class="form-control " />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
