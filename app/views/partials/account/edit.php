                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-login"  value="<?php  echo $data['login']; ?>" type="text" placeholder="Entrar  Login"  required="" name="login"  data-url="api/json/account_login_value_exist/" data-loading-msg="Checando disponibilidade ..." data-available-msg="Disponível" data-unavailable-msg="Não disponível" class="form-control  ctrl-check-duplicate" />
