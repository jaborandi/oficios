		...
		<nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					...
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/about') ?>">Sobre nós</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/help') ?>">Ajuda e FAQ</a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/contact') ?>">Contate-Nos</a>
					</li>
				</ul>
			</div>
		</nav>
