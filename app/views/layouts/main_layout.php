...
<html>
	...
	<body id="<?php echo $page_id ?>" class="with-login <?php echo $body_class ?>">
			...
			<div id="main-content">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a href="" id="delete-record-modal-btn" class="btn btn-primary">Excluir</a> 
							</div>
						</div>
					</div>
				</div>
				...
				<template id="page-loading-indicator">
					<div class="p-2 text-center m-2 text-muted m-auto">
						...
						<h4 class="p-3 mt-2 font-weight-light">Carregando...</h4>
					</div>
				</template>
				<template id="page-saving-indicator">
					<div class="p-2 text-center m-2 text-muted">
						<div class="lds-dual-ring"></div>
						<h4 class="p-3 mt-2 font-weight-light">Registro de economia</h4>
					</div>
				</template>
		...
		<?php
			...
			Html ::  page_js('locale/flatpickr/portuguese.js');
