...
?>
	...
	?>
		<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#-import-data">
			<i class="icon-notebook"></i> <?php echo $button_text; ?>
		</button>
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					...
					<div class="modal-body">
						<label>Selecione um arquivo para importar <input required="required" class="form-control form-control-sm" type="file" name="file" /> </label>
						<small class="text-muted">(csv , json)</small>
	...
	?>
		...
		?>
			<span class="sort-icon dropdown-toggle"></span>	<!-- <i class="icon-arrow-up"></i> -->
		<?php
		} else {
		?>
			<span class="sort-icon dropdown-toggle inverse text-muted"></span> <!-- <i class="icon-arrow-down"></i> -->
		<?php
		}
		?>
	<?php
