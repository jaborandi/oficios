					...
					?>
						<div class="<?php echo $list_page_class ?>">
							<ul class="pagination pagination-sm">
								...
								?>
									<li class="page-item">
										<a class="page-link" title="First Page"><i class="icon-arrow-left-circle"></i></a>
									</li>
								<?php
								}
								...
								?>
									<li class="page-item">
										<a class="page-link" title="Previous Page"><i class="icon-arrow-left"></i></a>
									</li>
									<?php
								}
								...
								?>
									<li class="page-item">
										<a class="page-link" title="Next Page"><i class="icon-arrow-right"></i></a>
									</li>
								<?php
								}
								//last button
								...
								?>
									<li class="page-item">
										<a class="page-link" title="Last Page"><i class="icon-arrow-right-circle"></i></a>
									</li>
								<?php
								}
								?>
